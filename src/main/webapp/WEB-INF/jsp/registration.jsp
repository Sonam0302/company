...
<body>
	<div class="login-page">
		<div class="form">
			<h1>Register Here</h1>
			<form action="save" method="POST" id="userlogin" class="login-form"
				...
				<label class="upload-btn"> <input type="file" name="image"
					onchange="changeText()" id="logo" size="50" accept=".jpg,.png,.bmp" />
					<span id="selectedFileName">Please Upload Your Company Logo</span>
				<div id="logo_error" style="color: red;"></div>
				</label> <input type="submit" name="submit" value="submit" class="submit"
					id="submit" />
			</form>
			...
			<p class="message">
				Already Registered? <a href="/company/">Login Here</a>
			</p>
		</div>
	</div>
</body>
